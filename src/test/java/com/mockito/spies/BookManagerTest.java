...
public class BookManagerTest {
	...
	public void testMockitoSpy() {
		...
		// We need to mock findBook because it is either communicating to database or not implemented
		...
		// This STUB way doesn't call the method
		doReturn(book).when(bookService).findBook("1234");
		//This STUB way it actually calls the method
